...
type
  _ScaleableButton = class(TButton)
  private
  ...
  TModTextScalingButton = class(_ScaleableButton)
  private
    fOnScaleChange: TScaleEvent;
  protected
    procedure ModScaleChange(Sender: TObject; CurTextSize: Integer;
      var NewLeft, NewTop, NewWidth, NewHeight, NewTextSize: Integer); virtual;
  public
    constructor Create(AOwner: TComponent); override;
  published
    property OnScaleChange: TScaleEvent read fOnScaleChange
  ...
  TScaleableButton = class(TModTextScalingButton)
  public
...
procedure Register;
begin
  RegisterComponents('Scaleable Controls', [TScaleableButton]);
end;

{ _ScaleableButton }


function _ScaleableButton.CanScaleX: Boolean;
begin
...
function _ScaleableButton.CanScaleY: Boolean;
begin
  Result := DoScaling and (not NoUpScaling or
...
constructor _ScaleableButton.Create(AOwner: TComponent);
begin
  inherited;
  fDoScaling := True;
...
procedure _ScaleableButton.DesignFontChange(Sender: TObject);
begin
  inherited Font.Assign(fDesignFont);
end;

function _ScaleableButton.GetAlign: TAlign;
begin
  Result := inherited Align;
end;

function _ScaleableButton.GetAnchors: TAnchors;
begin
...
function _ScaleableButton.GetDesignFontSize: Integer;
begin
  Result := Font.Size;
end;

function _ScaleableButton.GetFont: TFont;
begin
  if csDesigning in ComponentState then
...
function _ScaleableButton.GetHeight: Integer;
begin
  Result := inherited Height;
end;

function _ScaleableButton.GetLeft: Integer;
begin
  Result := inherited Left;
end;

function _ScaleableButton.GetScaledFontSize: Integer;
begin
  Result := inherited Font.Size;
end;

function _ScaleableButton.GetTop: Integer;
begin
  Result := inherited Top;
end;

function _ScaleableButton.GetWidth: Integer;
begin
  Result := inherited Width;
end;

procedure _ScaleableButton.ProcessXAnchors(ModParentClientWidth: Integer;
...
procedure _ScaleableButton.ProcessYAnchors(ModParentClientHeight: Integer;
...
procedure _ScaleableButton.Rescale;
var
...
procedure _ScaleableButton.ScaleControl(out NewLeft, NewTop, NewWidth, NewHeight,
...
procedure _ScaleableButton.ScaleText(var FontSize, NewWidth, NewHeight: Integer);
var
  NewFontSize: Integer;
  NegSize: Boolean;
begin
...
procedure _ScaleableButton.ScaleX(ModParentClientWidth: Integer; out NewLeft,
  NewWidth: Integer);
var
  XCentred: Boolean;
  XPos, XDim: Integer;
...
procedure _ScaleableButton.ScaleY(ModParentClientHeight: Integer; out NewTop,
  NewHeight: Integer);
var
  YCentred: Boolean;
  YPos, YDim: Integer;
...
procedure _ScaleableButton.SetAlign(const Value: TAlign);
begin
...
procedure _ScaleableButton.SetAnchors(const Value: TAnchors);
begin
  if csDesigning in ComponentState then
...
procedure _ScaleableButton.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
var
...
procedure _ScaleableButton.SetDesignBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure _ScaleableButton.SetDesignHeight(const Value: Integer);
var
  NewTop: Integer;
begin
...
procedure _ScaleableButton.SetDesignLeft(const Value: Integer);
begin
  if Value = fDesignLeft then Exit;
  SetDesignBounds(Value, fDesignTop, fDesignWidth, fDesignHeight);
end;

procedure _ScaleableButton.SetDesignTop(const Value: Integer);
begin
  if Value = fDesignTop then Exit;
  SetDesignBounds(fDesignLeft, Value, fDesignWidth, fDesignHeight);
end;

procedure _ScaleableButton.SetDesignWidth(const Value: Integer);
var
  NewLeft: Integer;
begin
...
procedure _ScaleableButton.SetDoScaling(const Value: Boolean);
begin
...
procedure _ScaleableButton.SetFont(const Value: TFont);
begin
...
procedure _ScaleableButton.SetHeight(const Value: Integer);
begin
  SetScaledBounds(inherited Left, inherited Top, inherited Width,  Value);
end;

procedure _ScaleableButton.SetLeft(const Value: Integer);
begin
  SetScaledBounds(Value, inherited Top, inherited Width,  inherited Height);
end;

procedure _ScaleableButton.SetMaxFontSize(const Value: Integer);
begin
...
procedure _ScaleableButton.SetMinFontSize(const Value: Integer);
begin
...
procedure _ScaleableButton.SetNoUpScaling(const Value: Boolean);
begin
...
procedure _ScaleableButton.SetParent(AParent: TWinControl);
begin
...
procedure _ScaleableButton.SetScaledBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure _ScaleableButton.SetScalings(const Value: TScalings);
begin
...
procedure _ScaleableButton.SetStaticDims(out StaticX, StaticY: Integer);
begin
  StaticX := 0;
  StaticY := 0;
...
procedure _ScaleableButton.SetTop(const Value: Integer);
begin
  SetScaledBounds(inherited Left, Value, inherited Width,  inherited Height);
end;

procedure _ScaleableButton.SetWidth(const Value: Integer);
begin
  SetScaledBounds(inherited Left, inherited Top, Value,  inherited Height);
end;

procedure _ScaleableButton.UpdateDesignCLs;
begin
  fDesignXCentre := fDesignLeft + fDesignWidth div 2;
  fDesignYCentre := fDesignTop + fDesignHeight div 2;
end;

procedure _ScaleableButton.UpdateDesignDims(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
{ TModTextScalingButton }

constructor TModTextScalingButton.Create(AOwner: TComponent);
begin
  inherited;
  inherited OnScaleChange := ModScaleChange;
end;

procedure TModTextScalingButton.ModScaleChange(Sender: TObject;
  CurTextSize: Integer; var NewLeft, NewTop, NewWidth, NewHeight,
  NewTextSize: Integer);
var
  TextHeight: Integer;
  NegSize: Boolean;
begin
  Negsize := NewTextSize < 0;
  TextHeight := Abs(CurTextSize) * Font.PixelsPerInch div 72;
  if TextHeight > NewHeight-2 then
    NewTextSize := (NewHeight-2) * 72 div Font.PixelsPerInch;
  if NegSize then
    NewTextSize := -NewTextSize;
  if Assigned(OnScaleChange) then begin
    CurTextSize := NewTextSize;
    OnScaleChange(Sender, CurTextSize, NewLeft, NewTop, NewWidth,
        NewHeight, NewTextSize);
  end;
end;

{ TScaleableButton }

procedure TScaleableButton.SetBounds(ALeft, ATop, AWidth,
  AHeight: Integer);
begin
