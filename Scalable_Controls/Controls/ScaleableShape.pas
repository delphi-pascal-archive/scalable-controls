...
uses
  ...
  ScaleableControl, ExtCtrls;

type
  TScaleableShape = class(TShape)
  private
...
procedure Register;
begin
  RegisterComponents('Scaleable Controls', [TScaleableShape]);
end;

{ TScaleableShape }

function TScaleableShape.CanScaleX: Boolean;
begin
...
function TScaleableShape.CanScaleY: Boolean;
begin
  Result := DoScaling and (not NoUpScaling or
...
constructor TScaleableShape.Create(AOwner: TComponent);
begin
  inherited;
  fDoScaling := True;
...
procedure TScaleableShape.DesignFontChange(Sender: TObject);
begin
  inherited Font.Assign(fDesignFont);
end;

function TScaleableShape.GetAlign: TAlign;
begin
  Result := inherited Align;
end;

function TScaleableShape.GetAnchors: TAnchors;
begin
...
function TScaleableShape.GetDesignFontSize: Integer;
begin
  Result := Font.Size;
end;

function TScaleableShape.GetFont: TFont;
begin
  if csDesigning in ComponentState then
...
function TScaleableShape.GetHeight: Integer;
begin
  Result := inherited Height;
end;

function TScaleableShape.GetLeft: Integer;
begin
  Result := inherited Left;
end;

function TScaleableShape.GetScaledFontSize: Integer;
begin
  Result := inherited Font.Size;
end;

function TScaleableShape.GetTop: Integer;
begin
  Result := inherited Top;
end;

function TScaleableShape.GetWidth: Integer;
begin
  Result := inherited Width;
end;

procedure TScaleableShape.ProcessXAnchors(ModParentClientWidth: Integer;
...
procedure TScaleableShape.ProcessYAnchors(ModParentClientHeight: Integer;
...
procedure TScaleableShape.Rescale;
var
...
procedure TScaleableShape.ScaleControl(out NewLeft, NewTop, NewWidth, NewHeight,
...
procedure TScaleableShape.ScaleText(var FontSize, NewWidth, NewHeight: Integer);
var
  NewFontSize: Integer;
  NegSize: Boolean;
begin
...
procedure TScaleableShape.ScaleX(ModParentClientWidth: Integer; out NewLeft,
  NewWidth: Integer);
var
  XCentred: Boolean;
  XPos, XDim: Integer;
...
procedure TScaleableShape.ScaleY(ModParentClientHeight: Integer; out NewTop,
  NewHeight: Integer);
var
  YCentred: Boolean;
  YPos, YDim: Integer;
...
procedure TScaleableShape.SetAlign(const Value: TAlign);
begin
...
procedure TScaleableShape.SetAnchors(const Value: TAnchors);
begin
  if csDesigning in ComponentState then
...
procedure TScaleableShape.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
var
...
procedure TScaleableShape.SetDesignBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure TScaleableShape.SetDesignHeight(const Value: Integer);
var
  NewTop: Integer;
begin
...
procedure TScaleableShape.SetDoScaling(const Value: Boolean);
begin
...
procedure TScaleableShape.SetFont(const Value: TFont);
begin
...
procedure TScaleableShape.SetHeight(const Value: Integer);
begin
  SetScaledBounds(inherited Left, inherited Top, inherited Width,  Value);
end;

procedure TScaleableShape.SetLeft(const Value: Integer);
begin
  SetScaledBounds(Value, inherited Top, inherited Width,  inherited Height);
end;

procedure TScaleableShape.SetMaxFontSize(const Value: Integer);
begin
...
procedure TScaleableShape.SetMinFontSize(const Value: Integer);
begin
...
procedure TScaleableShape.SetNoUpScaling(const Value: Boolean);
begin
...
procedure TScaleableShape.SetParent(AParent: TWinControl);
begin
...
procedure TScaleableShape.SetScaledBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure TScaleableShape.SetScalings(const Value: TScalings);
begin
...
procedure TScaleableShape.SetStaticDims(out StaticX, StaticY: Integer);
begin
  StaticX := 0;
  StaticY := 0;
